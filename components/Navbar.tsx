          ...
          <div className={styles.desktopNav}>
            ...
            >
              <button className={styles.servicesButton}>
                SERVICES
                <svg 
                  className={`${styles.dropdownIcon} ${isServicesOpen ? styles.dropdownIconOpen : ''}`}
                  viewBox="0 0 20 20" 
                  fill="currentColor"
                >
          ...
          <div className={styles.mobileNavPanel}>
            <div className={styles.mobileNavContent}>
              ...
              <div className={styles.mobileServicesContainer}>
                ...
                <div className={`${styles.mobileDropdownMenu} ${isMobileServicesOpen ? styles.mobileDropdownMenuOpen : ''}`}>
                  {serviceItems.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
